...
public enum Translation {
	...
	STATUS_STRUCTURES("status.structures"),
	...
	MENU_SELECTION_EXPORT_TILES_JSON("menu.selection.export_tiles_json"),
	...
	DIALOG_SETTINGS_RENDERING_STRUCTURE_ICONS("dialog.settings.rendering.structure_icons"),
	DIALOG_SETTINGS_RENDERING_STRUCTURE_ICON_SIZE("dialog.settings.rendering.structure_icon_size"),
	DIALOG_SETTINGS_RENDERING_STRUCTURE_ICON_BORDER_SIZE("dialog.settings.rendering.structure_icon_border_size"),
	...
	DIALOG_EDIT_OVERLAYS_TAB_PRESETS("dialog.edit_overlays.tab_presets"),
	DIALOG_EDIT_OVERLAYS_TAB_SCRIPT("dialog.edit_overlays.tab_script"),
	DIALOG_EDIT_OVERLAYS_CREATE_OVERLAY("dialog.edit_overlays.create_overlay"),
	...
	DIALOG_PROGRESS_TITLE_EXPORTING_TILES_JSON("dialog.progress.title.exporting_tiles_json"),
	DIALOG_EXPORT_TILES_JSON_TITLE("dialog.export_tiles_json.title"),
	DIALOG_EXPORT_TILES_JSON_HEADER("dialog.export_tiles_json.header"),
	DIALOG_EXPORT_TILES_JSON_OPTIONS_MIN_Y("dialog.export_tiles_json.options.min_y"),
	DIALOG_EXPORT_TILES_JSON_OPTIONS_MAX_Y("dialog.export_tiles_json.options.max_y"),
	DIALOG_EXPORT_TILES_JSON_OPTIONS_INCLUDE_AIR("dialog.export_tiles_json.options.include_air"),
	DIALOG_EXPORT_TILES_JSON_OPTIONS_COMPRESS("dialog.export_tiles_json.options.compress"),
